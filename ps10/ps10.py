...
class Hand(object):
    ...
    def isEmpty(self):
        ...
        """
        for items in self.handDict:
            if self.handDict[items] > 0:
                return False
        return True
    ...
    def __eq__(self, other):
        ...
        # TODO
        for items in self.handDict:
            if self.handDict[items] != other[items]:
                return False
        for items in other:
            if self.handDict[items] != other[items]:
                return False
...
class ComputerPlayer(Player):
    ...
    def pickBestWord(self, wordlist):
        ...
        type(hand)==Hand
        bestWord=''
        for words in wordlist.wordlist:
            if hand.containsLetters(words): 
                if getWordScore(words)>getWordScore(bestWord):
                     bestWord=words
        print bestWord
